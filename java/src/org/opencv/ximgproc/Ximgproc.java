...
public class Ximgproc {
    ...
    //
    // C++:  Vec4i HoughPoint2Line(Point houghPoint, Mat srcImgInfo, int angleRange = ARO_315_135, int makeSkew = HDO_DESKEW, int rules = RO_IGNORE_BORDERS)
    //
    ...
    //
    // C++:  void FastHoughTransform(Mat src, Mat& dst, int dstMatDepth, int angleRange = ARO_315_135, int op = FHT_ADD, int makeSkew = HDO_DESKEW)
    //
    ...
    public static void FastHoughTransform(Mat src, Mat dst, int dstMatDepth)
    {
        ...
        FastHoughTransform_1(src.nativeObj, dst.nativeObj, dstMatDepth);
    ...
    private static native void FastHoughTransform_1(long src_nativeObj, long dst_nativeObj, int dstMatDepth);
